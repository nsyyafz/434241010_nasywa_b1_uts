...
class TrackingAdminScreen extends StatelessWidget {
  final Ticket ticket;
  const TrackingAdminScreen({super.key, required this.ticket});
  ...
  List<Map<String, dynamic>> _getSteps() {
    final allSteps = [
      ...
      {'label': 'Sedang Diproses', 'sub': 'Assigned to: ${ticket.assignee}', 'status': 'active'},
          ...
          children: [
            ...
            OutlinedButton.icon(
              onPressed: () => Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (_) => DetailTiketAdminScreen(ticket: ticket)),
              ),
